...
const genericWords = new Set([
  ...
  "جب", "تب", "اب", "سب", "کہ", "کون", "کس", "کسے", "کیسے", "کیسا", "کیسی", "کیوں", "کتنا",
  ...
  "بعض", "نا", "شرعا", "شرعاً", "بنا", "بنائے", "بنائی", "بنانے", "بھیجتے", "بھیجتا", "بھیجتی", "بھیجنا", "بھیجے", "عمل"
]);
...
const synonymDict: Record<string, string[]> = {
  ...
  // Organ Donation / Medical Operations
  "گردہ": ["گردہ", "گردے", "کڈنی", "اعضاء", "اعضا", "جگر"],
  "گردے": ["گردے", "گردہ", "کڈنی", "اعضاء", "اعضا", "جگر"],
  "کڈنی": ["کڈنی", "گردہ", "گردے", "اعضاء", "اعضا"],
  "اعضاء": ["اعضاء", "اعضا", "گردہ", "گردے", "کڈنی", "جگر", "جسم"],
  "اعضا": ["اعضا", "اعضاء", "گردہ", "گردے", "کڈنی", "جگر", "جسم"],
  "عطیہ": ["عطیہ", "وقف", "ڈونیٹ", "ڈونیشن", "دینا", "ہبہ"],
  "وقف": ["وقف", "عطیہ", "ڈونیٹ", "ڈونیشن", "دینا", "ہبہ"],
};
